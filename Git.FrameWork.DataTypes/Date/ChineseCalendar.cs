...
namespace Git.Framework.DataTypes.Date
{
    public class ChineseCalendar
    {
        ...
        private bool CompareWeekDayHoliday(DateTime date, int month, int week, int day)
        {
            ...
            if (date.Month == month)
            {
                if (this.ConvertDayOfWeek(date.DayOfWeek) != day)
                {
                    return flag;
                }
                DateTime time = new DateTime(date.Year, date.Month, 1);
                int num = this.ConvertDayOfWeek(time.DayOfWeek);
                int num2 = (7 - this.ConvertDayOfWeek(time.DayOfWeek)) + 1;
                if (num > day)
                {
        ...
        private string GetChineseHour(DateTime dt)
        {
            ...
            char ch = (ganStr.Substring(startIndex) + ganStr.Substring(0, startIndex + 2))[num3];
            ch = zhiStr[num3];
            string introduced13 = ch.ToString();
            return (introduced13 + ch.ToString());
        }
        ...
        private int GetChineseYearDays(int year)
        {
            int num3 = 0x15c;
            int num = 0x8000;
            int num4 = LunarDateArray[year - 0x76c] & 0xffff;
            for (int i = 0; i < 12; i++)
            {
                int num2 = num4 & num;
                if (num2 > 0)
            ...
            return (num3 + this.GetChineseLeapMonthDays(year));
        }
        ...
        public string ChineseConstellation
        {
            get
            {
                ...
                return ((index >= 0) ? _chineseConstellationName[index] : _chineseConstellationName[0x1b + index]);
            }
        }
        ...
        public string ChineseDayString
        {
            get
            {
                ...
                return (introduced3 + ch.ToString());
            }
        }
        ...
        public string GanZhiDayString
        {
            get
            {
                ...
                return (introduced5 + ch.ToString() + "日");
            }
        }
        ...
        public string GanZhiYearString
        {
            get
            {
                ...
                char ch = ganStr[num % 10];
                ch = zhiStr[num % 12];
                string introduced4 = ch.ToString();
                return (introduced4 + ch.ToString() + "年");
            }
        }
